      ...
      <div className="flex flex-col  md:flex-row lg:gap-[4vw] w-[100vw] h-[100vh] md:w-auto ">
        ...
        <div className="absolute left-0  top-0 md:relative  md:flex w-full md:w-[60vw] lg:w-[50vw] items-center justify-center p-3 md:p-5">
          ...
          <div className="absolute flex items-start justify-start ml mb-[190px]">
            <h1 className="hidden md:block text-[#4C85C7] text-[40px] leading-[42px] sm:text-30px md:text-[40px] font-bold font-inter">
              FCore
            </h1>
          </div>
        </div>
        ...
        <div className="w-full md:w-[40vw]  lg:w-[30vw] text-center md:text-left bg-white/40 md:bg-transparent flex flex-col justify-center px-6 sm:px-8 py-10 h-full relative  ">
          {/* Logo */}
          <img src={logo} alt="Company Logo" className="w-[112px] mx-auto md:mx-0 h-[60px] mb-[2px] md:mb-2  " />

          {/* Page Title & Subtitle */}
          {title && <h1 className="text-[30px] font-semibold text-gray-1 mb-1 md:mb-4">{title}</h1>}
          {subtitle && <p className="text-gray-1 font-[400] leading-[24px] text-[16px] mb-4 md:mb-6">{subtitle}</p>}
