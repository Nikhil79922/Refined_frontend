...
export default function Header() {
  ...
  return (
    <header style={{ zIndex: 49 }} className="flex fixed top-0 left-0 lg:left-[15.5vw] items-center justify-between h-[73px] border-b-[0.9px] border-gray-200 bg-gray-4 w-[100vw] lg:w-[84.5vw]">
