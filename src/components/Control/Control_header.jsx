      ...
      <div className="flex gap-[2px] h-[50px] sm:gap-3 md:gap-4 lg:gap-6 items-center mt-4 mb-6">
        {[
          ...
          <Link
            key={to}
            to={to}
            className={`text-[10px] md:text-[15.5px] lg:text-[16.5px] font-inter font-[600] px-2 py-1 rounded-sm transition-all box-border ${
              location.pathname === to ? "text-blue-1 border-b-2 border-blue-1 " : "text-gray-2"
            }`}
