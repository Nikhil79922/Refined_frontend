...
export default function DashboardContent() {
 ...
 <div className={`bg-white rounded-lg shadow p-4 ${isSlideOpen ? `lg:w-[82.5vw]` : `lg:w-[97.8vw]`} overflow-x-auto`}>
      ...
      <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: isdbo ? 0 : "auto", opacity: isdbo ? 0 : 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.5 }}   className="overflow-hidden max-h-[66vh] scrollbar-hide overflow-y-auto">
